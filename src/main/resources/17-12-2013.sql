...
insert  into `category`(`categoryID`,`categoryDescription`,`categoryName`,`categoryNote`,`parentCatID`,`status`) values (1,'description 1 description 1 description 1 description 1 description 1 description 1 description 1 description 1 description 1 description 1','cat1','note of category one ..... note of category one....note of category one',-1,1),(2,'description 1 description 1 description 1 description 1 description 1 description 1 description 1 description 2 description 2 description 2.....description 1 description 1 description 1 description 1 description 1 description 1 description 1 description 2 description 2 description 2.....description 1 description 1 description 1 description 1 description 1 description 1 description 1 description 2 description 2 description 2.....description 1 description 1 description 1 description 1 description 1 description 1 description 1 description 2 description 2 description 2.....description 1 description 1 description 1 description 1 description 1 description 1 description 1 description 2 description 2 description 2.....','cat2','note of category ..... note of category....',-1,1),(3,'The Supreme Court today started the hearing on the review petition filed by condemned Jamaat-e-Islami leader Abdul Quader Mollah against its verdict awarding him death penalty for his wartime. After holding hearing on the acceptability of the review petition in the morning, a five-member bench of the Appellate Division head by Chief Justice Md Muzammel Hossain decided to hear the main petition. As the court','cat3','The Supreme Court today started',-1,1),(4,'The Supreme Court today started the hearing on the review petition filed by condemned Jamaat-e-Islami leader Abdul Quader Mollah against its verdict awarding him death penalty for his wartime. After holding hearing on the acceptability of the review petition in the morning, a five-member bench of the Appellate Division head by Chief Justice Md Muzammel Hossain decided to hear the main petition. As the court','cat4','The Supreme Court today started',-1,1),(5,'The Supreme Court today started the hearing on the review petition filed by condemned Jamaat-e-Islami leader Abdul Quader Mollah against its verdict awarding him death penalty for his wartime. After holding hearing on the acceptability of the review petition in the morning, a five-member bench of the Appellate Division head by Chief Justice Md Muzammel Hossain decided to hear the main petition. As the court','cat5','The Supreme Court today started',2,1),(6,'The Supreme Court today started the hearing on the review petition filed by condemned Jamaat-e-Islami leader Abdul Quader Mollah against its verdict awarding him death penalty for his wartime. After holding hearing on the acceptability of the review petition in the morning, a five-member bench of the Appellate Division head by Chief Justice Md Muzammel Hossain decided to hear the main petition. As the court','cat6','The Supreme Court today started',1,1),(7,'Check the status of this server and its configuration. Use this page to verify that the server is set up correctly. The Status page will perform simple checks toward the Database to verify that the configured values actually work','cat 7','View all the system properties in the system.',-1,1),(8,'Check the status of this server and its configuration. Use this page to verify that the server is set up correctly. The Status page will perform simple checks toward the Database to verify that the configured values actually work','cat 8','View all the system properties in the system.',-1,1);
...
insert  into `organization`(`organizationID`,`contactDetails`,`description`,`location`,`name`,`timeSlotDuration`,`tradeLicense`,`tradingHour`) values (1,'Mob: 01911287205, email:proshad@gmail.com','mobile company','dhanmodi, dhaka, bangladesh','gramenphone','30','123456789','8am to 5 pm');
...
insert  into `productrate`(`productRateID`,`productID`,`rateID`) values (1,1,1),(2,1,2),(3,1,3),(4,1,4),(5,2,1),(6,3,1),(8,5,1),(9,6,1),(10,6,2),(11,5,2),(13,2,2),(14,2,4),(15,1,3),(16,3,4),(17,5,4),(18,6,3),(19,6,4);
